"""Main entry point for the travel insurance email routing flow using GraphEmailAccount."""
...
async def main():
    """Execute the email routing flow for unread emails via Microsoft Graph."""
    action_types = [
        ActionType(
    ...
    # Connect to Microsoft Graph email account (credentials from environment)
